...
const (
	...
	// CScalar is the empirically-determined capitalization emphasis scaling
	// factor.
	CScalar float64 = 0.733

	// NScalar is the empirically-determined negation scaling factor.
